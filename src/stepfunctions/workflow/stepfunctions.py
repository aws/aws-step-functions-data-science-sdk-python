...
from stepfunctions.workflow.widgets.utils import create_sfn_workflow_url, create_sfn_execution_url
...
class Workflow(object):
    ...
    def list_workflows(cls, max_items=100, client=None, html=False):
        ...
        Args:
            ...
            html (bool, optional): Renders the list as an HTML table (If running in an IPython environment). If the paramater is not provided, or set to False, a Python list is returned. (default: False)
